...
|---|---|---|---|---|---|
| 4 | 0 | 2 | 1 | 1 | 0/2 = %0 (iptal edilen kayıt hesaba dahil edilmez) |
...
| 2026-07-21 18:15 UTC | kısa vade | Altın (XAU/USD) | Al | 4085.29 USD/ons | 4105.50 USD/ons (~%0.5) | 4066.00 USD/ons (~%0.47, 16:00-17:30 pullback dibinin altı) | 7 | açık — **not:** bu sinyali üreten tarama, log'a yazmadan hemen önce bağlantı kesintisi yüzünden yarım kaldı (üst seviye tarafından kurtarıldı). Gerekçe: 14:00-16:00 güçlü yükseliş → 16:00-17:30 pullback/konsolidasyon → 17:45-18:15 rebound teyidi + "dönüş çekici" mum formasyonu (18:15 barı: uzun gövde, H4086.64/C4085.29). Kovalama yasağı geçti (4+ bar teyit var, tek yönlü sert hamle değil). Volatilite filtresi: 12 saatlik ranj ~41 puan, hedefin 3 katından küçük, sınırlama yok. Kayıt geçmişte, gerçek zamanlı olarak 18:30-19:00 barlarıyla (H4086.05/L4081.63, H4083.47/L4079.80, H4085.60/L4082.00) doğrulandı — ne hedef ne stop henüz tetiklenmedi. |
